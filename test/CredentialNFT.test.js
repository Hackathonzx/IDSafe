...
beforeEach(async function () {
  ...
  // Deploy the CredentialNFT contract without constructor parameters
  const CredentialNFT = await ethers.getContractFactory("CredentialNFT");
  credentialNFT = await CredentialNFT.deploy(); // No parameters needed
  await credentialNFT.deployed(); // Wait for deployment
});
